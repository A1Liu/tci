...
#[wasm_bindgen(method)]
pub fn get_source(this: &PipelineOutput) -> String {
    return this.source.clone();
}

#[wasm_bindgen]
pub fn compile(source: String) -> Result<PipelineOutput, String> {
    ...
    let parsed_ast = parse(&macro_expansion_res).map_err(|e| "parsing failed")?;
