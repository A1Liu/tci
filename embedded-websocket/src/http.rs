...
pub fn read_http_header<'headers, 'buf: 'headers>(
    ...
    let mut sec_websocket_protocol_list: Vec<heapless::String<U24>, U3> = Vec::new();
    ...
    let mut websocket_context = None;
    if is_websocket_request {
        websocket_context = Some(WebSocketContext {
            sec_websocket_protocol_list,
            sec_websocket_key,
        });
    };
